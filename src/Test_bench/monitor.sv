class apb_monitor;
          ...
          task start();
                    for(int i=0;i<`no_of_trans;i++) begin
                              ...
                              $display("MONITOR PASSING THE DATA TO SCOREBOARD PWRITE=%d PADDR=%d PSEL=%d PENABLE=%d PWDATA=%d PSTRB=%d PRDATA=%d transfer_done=%d error=%d ",mon_trans.PWRITE, mon_trans.PADDR, mon_trans.PSEL, mon_trans.PENABLE, mon_trans.PWDATA, mon_trans.PSTRB, mon_trans.PRDATA, mon_trans.transfer_done, mon_trans.error);
